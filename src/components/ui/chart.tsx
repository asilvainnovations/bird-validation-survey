...
/**
 * Recharts v3 no longer exposes `active`/`payload`/`label` on
 * ComponentProps<typeof Tooltip>, so the content props are declared
 * explicitly with a permissive payload item shape.
 */

    ...
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-[#065f46] dark:text-[#ecfdf5]/70 leading-relaxed max-w-3xl">
          ...
          email is used <strong>only</strong> to send you a copy of your
          submission and is protected under the Data Privacy Act of 2012 (RA
          10173).
        </p>
      </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-[#065f46] dark:text-[#ecfdf5]/60 mt-2 flex items-start gap-1.5">
                <Info className="w-3.5 h-3.5 flex-shrink-0 mt-0.5" />
                <span>
                  <strong>Why this matters:</strong> Your geographic affiliation
                  helps us identify region-specific investment priorities and
                  ensures equitable representation across BARMM&apos;s 5
                  provinces, the SGA, Cotabato City, and our external development
                  partners.
                </span>
              </p>
            </div>
      ...
      {/* Contextual Image: Provincial Specialized Nodes */}
      <div className="relative w-full overflow-hidden rounded-xl border border-[#C9A84C]/30 shadow-lg group">
        <img
          src={BIRD_IMAGES.provincialSpecializedNode.url}
          alt={BIRD_IMAGES.provincialSpecializedNode.alt}
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-5">
          <h4 className="text-[#C9A84C] font-semibold text-sm mb-1 flex items-center gap-2">
            ...
            {BIRD_IMAGES.provincialSpecializedNode.title}
          </h4>
          <p className="text-xs text-white/85 leading-relaxed">
            {BIRD_IMAGES.provincialSpecializedNode.description}
          </p>
        </div>
      </div>
      ...
      <Card className="border-[#C9A84C]/20 bg-white/95 dark:bg-[#022c22]/80 backdrop-blur-sm">
        ...
        <CardContent>
          <p className="text-xs text-[#065f46] dark:text-[#ecfdf5]/60 mb-4 italic">
            Select all that apply. This contextualizes your responses within the
      ...
      <div className="flex items-start gap-3 p-4 bg-[#ecfdf5]/40 dark:bg-[#C9A84C]/10 border border-[#C9A84C]/20 rounded-lg">
        ...
        <div className="text-xs text-[#065f46] dark:text-[#ecfdf5]/70 leading-relaxed">
          ...
          personal data collected is processed solely for the purpose of the
          BIRD 2026-2035 Validation Survey. Aggregated data will be used for
          public reporting, but no individual response will ever be publicly
          attributed to you without explicit consent.
        </div>
      </div>
    </div>
  );

...
export const createSamplePlan = (userInfo?: UserInfo): StrategicPlan => {
  ...
  plan.strategicOptions = [
    ...
    // ST
    createItem({ id: generateId(), optionType: 'ST' as TOWSQuadrant, title: 'Governance-Centered Investor Confidence Building (R2 Loop Activation)', description: 'Counter negative perception through BICC dashboard, BOI aftercare protocol, 1-day digital registration (BEGMP), and transparent procurement. Activates R2 Governance–Investor Confidence reinforcing loop.', priorityScore: 4, feasibilityScore: 4, selected: true, leveragePoint: 'LP3' as LeveragePoint, beieCluster: 'cross-cutting' as BEIECluster, birdPhase: '1' as BIRDPhase, swotPairs: 'S4 × T3', leverageLevel: 6, resourceRequirement: 'medium', approvedBy: userId, approvedAt: now }),
  ...
  plan.objectives = [
    ...
    },
    {
      ...
      description: 'Grow both FDI and domestic investment approvals from ₱5.1B (Q1 2026) through BOI facilitation, halal park development, and BIMP-EAGA corridors.',
      bscCode: 'F1', leveragePoint: 'LP1', beieCluster: 'connectors', birdPhase: '1',
      createdBy: userId, createdByName: userName, createdAt: now, champion: userId, championName: userName,
      kpis: [{
        id: generateId(), objectiveId: obj2Id, name: 'Annual Investment Approvals', description: 'Total BOI-approved investment value',
        ...
        benchmarkSource: 'BOI / BEZA Investment Reports (Q1 2026)',
      }],
    },
    {
  ...
  plan.paps = [
    ...
    createItem({ id: generateId(), objectiveId: obj2Id, papType: 'activity' as PAPType, name: 'BEGMP Digital Rollout & 1-Day Business Registration', description: 'Complete BEGMP deployment. Achieve 1-day digital business registration via BOI. Deploy BICC dashboard for real-time investment tracking.', owner: userId, ownerName: userName, ownerEmail: userEmail, budget: 150_000_000, spent: 0, startDate: '2026-01-01', endDate: '2026-12-31', progress: 20, status: 'in-progress' as PAPStatus, beieCluster: 'enablers' as BEIECluster, birdPhase: '1' as BIRDPhase, leveragePoint: 'LP3' as LeveragePoint, leadAgency: 'BDTA / MICT', sdgAlignment: 'SDG 8, 9, 17', teamMembers: [userId] }),
